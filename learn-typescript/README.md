...
- Prerequisites: Javascript Programming Language
...
- inferred Typing
  ...
  ```js
  let userName = "mukul"; // data type inferred as string
  ```
...
2. **object**: Represents any non-primitive value.
   ...
   user1 = { userName: "mukul", userId: 101 };
   users.push(user1);

   let user2: { userName: string; userId: number };
   user2 = { userName: "a", userId: 102 };
...
8. **class Type OOP** - You can create class type as well. class can have constructor, properties, methods. create object let objectName = new className()
   ...
   let user1 = new User("Samiur Rahman", 25);
   user1.display();

   let user2 = new User("Hello World", 31);
   user2.display();
   ```
...
10. **Interface vs type**
    ...
    const s1 = new Student("samiur rahman", "1302020017");
...
- Function signature
  ...
  userInfo1 = () => {
    console.log("Samiur Rahman is 22 years old");
  };
  ...
  userInfo1();
  userInfo2("Samiur Rahman");
  console.log(userInfo3("Samiur Rahman"));
  ```
